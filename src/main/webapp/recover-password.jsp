...
<c:if test="${requestScope.success == 'true'}">
  <div class="alert alert-success alert-dismissible fade show mb-3"
       style=" position: fixed;  bottom: 20px;right: 20px; z-index: 100;" role="alert">
    <span><i class="fas fa-thumbs-up"></i></span>
    <span> An email containing the reset<br>
      link has been successfully sent</span>
      ...
      <div class="row no-gutters">
        ...
        <div class="col-md-6 bg-white pt-5 pt-5 pb-lg-0 pb-5">
          <div class="sign-in-from">
            ...
            <form method="post" action="${pageContext.request.contextPath}/reset_password" class="mt-4">
              <input type="hidden" value="SEND_TOKEN" name="operation">
