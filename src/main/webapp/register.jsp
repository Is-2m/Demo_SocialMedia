            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-6 bg-white pt-5 pt-5 pb-lg-0 pb-5">
                    <div class="sign-in-from">
                        ...
                        <form method="post" action="RegisterServlet" class="mt-4">
                            <input type="hidden" name="operation" value="REGISTER">

                            <div class="form-group">
                                <label class="form-label" for="exampleInputEmail1">Your Full Name</label>
                                <input type="text" class="form-control mb-0" name="name" required="required" id="exampleInputEmail1" placeholder="Your Full Name">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="exampleInputEmail2">Email address</label>
                                <input type="email" name="email" required="required" class="form-control mb-0" id="exampleInputEmail2" placeholder="Enter email">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="exampleInputPassword1">Password</label>
                                <input type="password" name="password" required="required" class="form-control mb-0" id="exampleInputPassword1" placeholder="Password">
                            </div>
                            ...
                            <div class="sign-info">
                                <span class="dark-color d-inline-block line-height-2">Already Have Account ? <a href="login.jsp">Log In</a></span>
